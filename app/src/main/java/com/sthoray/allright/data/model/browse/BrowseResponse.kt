 ...
 * @property featuredPanel A list of featured categories to browse next. This contains less categories than [children] but each of these contain fancy images. This would be suitable for displaying at the top of search results.
...
data class BrowseResponse(
    ...
    val featuredPanel: List<CategoryFeature>?,
